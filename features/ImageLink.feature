Feature: Image Links
  ...
  Scenario: As a user, I should be able to create and delete Image Links
    ...
    And I will see the text "Your Image Link has been created."
    ...
    When I click "edit"
    Then I will see the text "Editing the Image Link: I Feel Ecstatic!"
    And I will see the element "#image_link_url"
    And I will see the element "#image_link_title"
    And I fill in "image_link_title" with the text "I Feel Ecstatic! - Edited by Test"
    And I click "save"
    Then I will see the text "Your Image Link has been updated."
    And I will see the text "I Feel Ecstatic! - Edited by Test"
    And I will not see the text "1 favorites"
    When I click "favorite"
    Then I will see the text "1 favorites"
    And I click "favorite"
    Then I will see the text "2 favorites"
    When I click "delete"
